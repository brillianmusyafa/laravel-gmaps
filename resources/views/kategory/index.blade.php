...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <a href="{{ url('/kategory/create') }}" class="btn btn-primary btn-xs" title="Add New Kategory"><span class="glyphicon glyphicon-plus" aria-hidden="true"/></a>
        <br/>
        <br/>
        <div class="table-responsive">
            <table class="table table-borderless">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $item->id }}</td>
                        <td>{{ $item->name }}</td><td><img src="img/{{ $item->icon }}"></td>
                        <td>
                            <a href="{{ url('/kategory/' . $item->id . '/edit') }}" class="btn btn-primary btn-xs" title="Edit Kategory"><span class="glyphicon glyphicon-pencil" aria-hidden="true"/></a>
                            {!! Form::open([
                                'method'=>'DELETE',
